...
<section class="page-title bg-dark parallax pb-10 pt-90" data-jarallax='{"speed": 0.6}' style="background-image: url(images/bg/programming2.jpg);">
    <div class="container">
      ...
      <div class="row">
        <ul class="page-breadcrumb pb-10">
          <li><a href="{{route('category')}}"><i class="fa fa-home"></i> Todas las categorías</a> <i class="fa fa-angle-double-right"></i></li>
          <li><a href="">Desarrollo Web</a></li>
        </ul>
        <div class="feature-text left-icon round feature-border pt-10">
    ...
    <div class="row">
      <ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item">
          <a class="nav-link" id="community-06-tab" data-toggle="tab" href="#community-06" role="tab" aria-controls="community-06" aria-selected="true"> <i class="fa fa-home mr-2"></i> Inicio</a>
        </li>
        <li class="nav-item">
...
<section class="page-sidebar page-section-pb bg-gray2 masonry-main">
  <div class="container">
    <div class="row">
      <div class="col-lg-3 col-md-4 sm">
        <div class="sticky-top">
          ...
          <div class="sidebar-widget pt-20 mb-40">
            <button type="button" class="button button-border border-primary btn-block"><i class="fa fa-code"></i> Desarrollo web</button>
            <button type="button" class="button button-border border-secondary btn-block">Diseño gráfico</button>
            <button type="button" class="button button-border border-warning btn-block">Programación</button>
            <button type="button" class="button button-border border-info btn-block">Lifestyle</button>
            <button type="button" class="button button-border border-success btn-block">Weed</button>
          </div>

          <div class="sidebar-widget">
            <h6 class="mt-40 mb-20">Publicaciones destacadas </h6>
       ...
       <div class="col-lg-9 col-md-5 page-content">
        <br>
        ...
        <div class="tab tab-border nav-center bg-white">
                  ...
                  <div class="masonry-item">
                    <div class="blog-entry">
                      <div class="entry-image clearfix">
                            <img class="img-fluid" src="{{asset('lacompaniadigital/images/blog/011.jpg')}}" alt="">
                        </div>
                        <div class="blog-detail">
                          <div class="media">
                            <div class="media-body">
                              <div class="entry-title mb-10">
                                  <a href="blog_01.html">Slack: organiza la comunicación con tu equipo</a>
