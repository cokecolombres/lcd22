...
<section class="">
  ...
  <div class="container">
    <h3 class="text-white display-5 mt-50">AYUDA A TI <span class="theme-color">SE VIENE!!!</span>.</h3>
    <p class="text-white lead">LA CONCHA DEL PINGO</p>
  </div>
</div>
  </div>
</section>
  ...
  <div class="container-fluid">
      ...
      <div class="col-lg-12 col-md-12">
       <div class="tab nav-center">
          <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <li class="nav-item">
              <a class="nav-link" id="design-tab" data-toggle="tab" href="#design" role="tab" aria-controls="design" aria-selected="false"> Comunidades </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" id="develop-tab" data-toggle="tab" href="#develop" role="tab" aria-controls="develop" aria-selected="false"> Mi cuenta </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" id="result-tab" data-toggle="tab" href="#result" role="tab" aria-controls="result" aria-selected="false">  Noticias </a>
            </li>
          </ul>
    ...
    <div class="row">
       <div class="col-lg-12 text-center mt-40">
          <h6> Si no encuentras la respuesta a tu pregunta, nos puedes contactar directamente a <a class="theme-color" href="#">contacto@lacompaniadigital.com</a> </h6>
       </div>
    </div>
  </div>
</section>
