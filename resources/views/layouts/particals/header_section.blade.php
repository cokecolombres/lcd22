        ...
        <div class="owl-carousel" data-items="5" data-md-items="4" data-sm-items="3" data-xs-items="2" data-xx-items="2" data-nav-dots="false">
          ...
          <div class="item">
            <div class="blog-box blog-1 h-100 bg-white">
              <div class="blog-info">
                <span class="post-category"><a class="bg-primary" href="#">Diseño gráfico</a></span>
                <h4> <a href="blog_01.html"> La identidad visual... si importa</a></h4>
                <p>I truly believe Augustine’s words are true and if you look at history you know it is true.</p>
              </div>
              <div class="blog-box-img" style="background-image:url({images/blog/013.jpg});"></div>
            </div>
          </div>
          ...
          <div class="item">
            <div class="blog-box blog-1 h-100 active">
              <div class="blog-info">
                <span class="post-category"><a class="bg-info" href="#">Herramientas digitales</a></span>
                <h4> <a href="#"> Las herramientas digitales colaborativas</a></h4>
                <p>I truly believe Augustine’s words are true and if you look at history you know it is true.</p>
              </div>
              <div class="blog-box-img" style="background-image:url(images/blog/011.jpg);"></div>
            </div>
          </div>
          ...
          <div class="item">
            <div class="blog-box blog-1 h-100 bg-white">
              <div class="blog-info">
                <span class="post-category"><a class="bg-danger" href="#">Marketing</a></span>
                <h4> <a href="#"> Genera mayores ventas y fortalece tu posicionamiento.</a></h4>
                <p>I truly believe Augustine’s words are true and if.</p>
              </div>
              <div class="blog-box-img" style="background-image:url(images/blog/011.jpg);"></div>
            </div>
          </div>
          ...
          <div class="item">
            <div class="blog-box blog-1 h-100 bg-white">
              <div class="blog-info">
                <span class="post-category"><a class="gray-bg" href="#">Diseño gráfico</a></span>
                <h4> <a href="#"> La identidad visual... si importa</a></h4>
                <p>I truly believe Augustine’s words are true and if you look at history you know it is true.</p>
              </div>
              <div class="blog-box-img" style="background-image:url(images/blog/011.jpg);"></div>
            </div>
      ...
      <div class="col-lg-6 col-md-6">
          ...
          <div class="card-body">
            ...
            <ul class="list-group">
              <a href="{{route('blog')}}" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                Músicos de Cordoba
                <span class="badge badge-secondary">Hace 17 minutos</span>
              </a>
              <a href="{{route('blog')}}" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                Diseñadores gráficos (old School)
                <span class="badge badge-secondary">Hace 2 horas</span>
              </a>
              <a href="{{route('blog')}}" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                Carpintería Tucumán
                <span class="badge badge-secondary">Ayer</span>
              </a>
            </ul>
          </div>
        </div>
